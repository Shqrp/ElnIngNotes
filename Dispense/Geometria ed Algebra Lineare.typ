...
#definition(title: [Generatore di vettori], [
...
#definition(title: [Dipendenza ed indipendenza lineare], [
...
#proposition(title: [Condizione di dipendenza lineare], [
...
#proposition(title: [Unicità delle combinazioni lineari di vettori in una base], [
  Se $B = {v_1, ..., v_n}$ è una base, allora i suoi vettori sono linearmente indipendenti. Dunque $u = c_1 v_1 + ... + c_n v_n$, con $c_i in KK$ unici.
])
#proof([
...
#definition(title: [Equazione cartesiana di un piano in $AA_3$], [
...
#definition(title: [Equazione cartesiana di una retta in $AA_3$], [
...
#definition(title: [Posizioni reciproche di rette in $AA_3$], [
...
#definition(title: [Somma fra matrici], [
...
#definition(title: [Prodotto per uno scalare di una matrice], [ 
...
#definition(title: [Prodotto riga per colonna], [
...
#proposition(title: [Soluzione di sistemi lineari], [
...
#definition(title: [Kernel di una matrice], [
...
#note-box([
  ...
  - Se $v_1, ..._ v_n$ in $(KK^m, +, dot, KK)$ con $n > m$, allora $v_1, ..., v_n$ sono linearmente dipendenti \ $=> ker(A) != {underline(0)}$ quindi $ker(A)$ dipende da almeno un parametro
])
...
#definition(title: [Matrice a scala], [
  Una matrice A è detta _a scala_ se è della forma:
  $ mat(0, ..., 0, P_1, ..., ..., ..., ..., ...; 0, ..., ..., 0, ..., 0, P_2, ..., ... ; dots.v, , , dots.down, , dots.down, , , dots.v; 0, ..., ..., ..., ..., ..., ..., 0, P_r;
  0, ..., ..., ..., ..., ..., ..., ..., 0) $
...
#definition(title: [Matrice a scala ridotta], [
...
#definition(title: [Rango di una matrice], [
...
#proposition(title: [Struttura di un sistema omogeneo], [
...
#proposition(title: [Proprietà di un sistema lineare], [
...
#theorem(title: [Teorema di Rouché-Capelli], [
...
#theorem(title: [Teorema di Cramer], [
...
#definition(title: [Inverse di una matrice], [
